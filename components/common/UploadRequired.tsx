...
const UploadRequired = () => {
  return (
    <div className='relative min-h-screen'>
      <BgGradient className='from-rose-100 via-pink-50 to-white' />
      ...
      <div className='container px-8 py-16'>
        <div className='flex flex-col items-center justify-center gap-8 text-center max-w-2xl mx-auto'>
          ...
          <p className='text-lg leading-8 text-gray-600 border-2 border-rose-200 bg-white/50 backdrop-blur-xs rounded-lg p-border-dashed max-w-xl '>
          ...
          <Button
            asChild
            className='bg-linear-to-r bg-rose-500 to-rose-700  hover:from-rose-600 hover:to-rose-800 text-white'
          >
